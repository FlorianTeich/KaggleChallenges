...
def load_data(traindir, valdir, args):
    ...
    dataset = torchvision.datasets.CIFAR10(root="/home/florian/data/cifar10/", train=True,
                                            transform=presets.ClassificationPresetTrain(crop_size=crop_size, auto_augment_policy=auto_augment_policy,
                                              random_erase_prob=random_erase_prob), download=True)
    dataset_test = torchvision.datasets.CIFAR10(root="/home/florian/data/cifar10/", train=False,
                                            transform=presets.ClassificationPresetTrain(crop_size=crop_size, auto_augment_policy=auto_augment_policy,
                                              random_erase_prob=random_erase_prob), download=True)
